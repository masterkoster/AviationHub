...
[![Desktop Boundary](https://github.com/masterkoster/next-dashboard/actions/workflows/desktop-boundary.yml/badge.svg)](https://github.com/masterkoster/next-dashboard/actions/workflows/desktop-boundary.yml)
...
[![Download Latest](https://img.shields.io/badge/Download-Latest%20Release-blue)](https://github.com/masterkoster/next-dashboard/releases/latest)
...
### Installation
1. Download the latest NSIS installer from [Releases](https://github.com/masterkoster/next-dashboard/releases/latest)
2. Run the `.exe` file
